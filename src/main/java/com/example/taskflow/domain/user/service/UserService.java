...
import com.example.taskflow.domain.user.dto.*;
...
public class UserService {
    ...
    // 담당자 설정
    public ApiResponse<List<FindUsernameResponseDto>> findUserList() {

        List<FindUsernameResponseDto> list =
                userRepository.findAll()
                        .stream()
                        .map(FindUsernameResponseDto::toDto)
                        .toList();
